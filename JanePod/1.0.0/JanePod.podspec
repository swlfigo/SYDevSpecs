Pod::Spec.new do |spec|
  spec.name             = "JanePod"                         #Pod的名字
  spec.version          = "1.0.0"                                     #版本号
  spec.summary          = "Jane简拼破解"
  spec.description      = <<-DESC                                     #Pod的描述
                          - A example pod for MonkeyDev
                        DESC

  spec.homepage         = "https://github.com/swlfigo/JanePod"   #Pod的地址
  ...
  spec.source           = { :git => "https://github.com/swlfigo/JanePod.git", :tag => spec.version.to_s }  #代码的git地址以及tag
  spec.source_files     = "JanePod/**/*.{h,m}"        #本地验证，表示当前目录以及子目录的所有h或m结尾的文件   如果发布到MonkeyPodSpecs需要填写git clone下来的对应的路径
  spec.public_header_files = "JanePod/JanePod.h"        #需要对外导出的头文件  此处为本地验证
